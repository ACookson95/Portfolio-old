  ...
  <div className='sidebar'>
    ...
    <div className='social-wrapper'>
      ...
      <div className='social'>
        <a href="https://www.github.com/ACookson95" target="_blank"><img src={GithubIcon} alt="social"/></a>
        <a href="https://www.linkedin.com/in/aaron-cookson/" target="_blank"><img src={LinkedinIcon} alt="social"/></a>
        <a href="https://www.facebook.com/Cookson.Aaron" target="_blank"><img src={FbIcon} alt="social"/></a>
        <a href="https://www.instagram.com/aaron_cookson/" target="_blank"><img src={InstaIcon} alt="social"/></a>
        <a href="https://www.twitter.com/aaroncookson?lang=en" target="_blank"><img src={TwitterIcon} alt="social"/></a>
      </div>
    </div>
  </div>
)
